...
if __name__=='__main__':
	...
	tstr="../kasumi_datasets/predict/predict_"+tstr+"/"
	os.makedirs(tstr)

	# 学習結果を読み込む
	model = model_from_json(open('../kasumi_models/model_predict/model.json').read())
	model.load_weights('../kasumi_models/model_predict/weights.h5')
	model.summary();
	model.compile(loss='mse',
		optimizer=Adam(),
		metrics=['accuracy'])
	input_data,file_list=load_data("../kasumi_datasets/predict/data/")
